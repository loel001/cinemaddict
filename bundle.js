...
/* harmony import */ var _models_film_card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/film-card */ "./src/models/film-card.js");
...
const API = class {
  ...
  getFilms() {
    return this._load({url: `movies`})
      ...
      .then(_models_film_card__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilmCards);
  }

  getComments(film) {
    return this._load({url: `comments/${film.id}`})
      .then((response) => response.json())
      .then((data) => _models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(data, film.id));
  }
    ...
    return this._load({
      ...
      .then((data) => {
        return {
          ...
          models: _models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(data.comments, filmId)
        };
      });
  }
  ...
  updateFilm(id, data) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_film_card__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilmCard);
  }
...
const createCommentTemplate = (comment, options) => {
  ...
  const commentDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatCommentDate"])(day);
  return (
...
class Comment extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(comment) {
    super();
...
const createFilmDetailsTemplate = (film) => {
  const emojiListMarkup = createEmojiListMarkup(_const__WEBPACK_IMPORTED_MODULE_0__["emojiNames"]);
  return (
...
const createFilmCardTemplate = (film) => {
  ...
  const year = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(date);
  ...
  const time = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(duration);
  const newDescription = currentDescription.length > 140 ? currentDescription.substr(0, 139) + `…` : currentDescription;
  const description = Object(he__WEBPACK_IMPORTED_MODULE_1__["encode"])(newDescription);
...
class FilmCard extends _abstract_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(film) {
    super();
...
class FilmCards extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createFilmDetailsTemplate = (film) => {
  ...
  const description = Object(he__WEBPACK_IMPORTED_MODULE_2__["encode"])(currentDescription);
  const genresMarkup = createGenresMarkup(genreNames);
  const genreTerm = genreNames.length > 1 ? `Genres` : `Genre`;
  const popupDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatPopupDate"])(date);
  const time = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(duration);
...
class FilmDetails extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
...
const createFilterMarkup = (filter, isChecked) => {
  ...
  return (
    `<a href="#${name}" data-filter="${name}" class="main-navigation__item ${isChecked ? `main-navigation__item--active` : ``}">${name} ${name === _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL ? `movies` : `<span class="main-navigation__item-count">${count}</span>`}</a>`
  );
};
...
class Footer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MostСommentedFilms; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class MostСommentedFilms extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
class Navigation extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setClickHandler(handler) {
    this.getElement().addEventListener(`click`, (evt) => {
      ...
      const item = evt.target.dataset.filter ? _const_js__WEBPACK_IMPORTED_MODULE_1__["NavigationItem"].FILTER : _const_js__WEBPACK_IMPORTED_MODULE_1__["NavigationItem"].STATISTIC;
      handler(item);
    });
  }
}
...
/***/ "./src/components/no-film-cards.js":
/*!*****************************************!*\
  !*** ./src/components/no-film-cards.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoFilmCards; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class NoFilmCards extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/site-profile.js":
/*!****************************************!*\
  !*** ./src/components/site-profile.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SiteProfile; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
const getUserName = (films) => {
  const count = Object(_utils_filter__WEBPACK_IMPORTED_MODULE_1__["getHistoryFilms"])(films).length;
  switch (true) {
...
class SiteProfile extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    super();
...
const getCurrentType = (filterType) => {
  switch (filterType) {
    case _const__WEBPACK_IMPORTED_MODULE_2__["StatisticFilterType"].TODAY:
      return `days`;
    case _const__WEBPACK_IMPORTED_MODULE_2__["StatisticFilterType"].WEEK:
      return `weeks`;
    case _const__WEBPACK_IMPORTED_MODULE_2__["StatisticFilterType"].MONTH:
      return `months`;
    case _const__WEBPACK_IMPORTED_MODULE_2__["StatisticFilterType"].YEAR:
      return `years`;
    default:
      return null;
  }
...
const getWatchedStatistic = (films, filterType) => {
  const watchedFilms = films.filter((film) => {
    return film.isHistory && Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["isSelectedType"])(film.watchingDate, new Date(), getCurrentType(filterType));
  });
...
const createStatisticsTemplate = (statistic, currentType) => {
  ...
  const durationFilm = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(totalDuration);
  let topGenre = ``;
  if (genres.length > 0) {
    topGenre = genres[0][0];
  }

  const filterTypesMarkup = _const__WEBPACK_IMPORTED_MODULE_2__["StatisticFilterTypes"].map((type) => createTypeFilterMarkup(type, currentType)).join(`\n`);
...
class Statistic extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(model) {
    super();
    this._model = model;
    this._currentType = _const__WEBPACK_IMPORTED_MODULE_2__["StatisticFilterType"].ALL_TIME;
    this._chart = null;
...
/***/ "./src/components/top-rated-films.js":
/*!*******************************************!*\
  !*** ./src/components/top-rated-films.js ***!
  \*******************************************/
/*! exports provided: default */
...
class TopRatedFilms extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: emojiNames, FilterType, StatisticFilterType, StatisticFilterTypes, NavigationItem, SHAKE_ANIMATION_TIMEOUT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticFilterTypes", function() { return StatisticFilterTypes; });
...
/* harmony import */ var _components_no_film_cards__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/no-film-cards */ "./src/components/no-film-cards.js");
...
/* harmony import */ var _components_film_cards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/film-cards */ "./src/components/film-cards.js");
/* harmony import */ var _film_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./film-card */ "./src/controllers/film-card.js");
/* harmony import */ var _components_most_commented_films__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/most-commented-films */ "./src/components/most-commented-films.js");
...
/* harmony import */ var _components_site_profile__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/site-profile */ "./src/components/site-profile.js");
/* harmony import */ var _components_top_rated_films__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/top-rated-films */ "./src/components/top-rated-films.js");
...
const renderFilmCards = (filmListElement, films, comments, api, onDataChange, onViewChange) => {
  return films.map((film) => {
    const filmCardController = new _film_card__WEBPACK_IMPORTED_MODULE_4__["default"](filmListElement, comments, api, onDataChange, onViewChange);
...
const getSortedFilms = (films, sortType, from, to) => {
  ...
  switch (sortType) {
    case _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].DEFAULT:
      sortedFilms = showingFilms;
      break;
    case _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].DATE_DOWN:
      sortedFilms = showingFilms.sort((a, b) => b.date - a.date);
      break;
    case _components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].RATING_DOWN:
...
class BoardController {
  constructor(container, models, api) {
    ...
    this._noFilmCards = new _components_no_film_cards__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._sortingComponent = new _components_sorting__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._filmCardsComponent = new _components_film_cards__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._loadMoreButtonComponent = new _components_load_more_button__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._mostСommentedFilmsComponent = new _components_most_commented_films__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._topRatedFilmsComponent = new _components_top_rated_films__WEBPACK_IMPORTED_MODULE_8__["default"]();
  ...
  render() {
    ...
    if (this._filmCardsModel.getFilms().length === 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(filmWrapper, this._noFilmCards);
      return;
    }

    this._renderProfile();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(siteHeader, this._siteProfileComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._sortingComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(filmWrapper, this._filmCardsComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._topRatedFilmsComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._mostСommentedFilmsComponent);
  ...
  _renderProfile() {
    this._siteProfileComponent = new _components_site_profile__WEBPACK_IMPORTED_MODULE_7__["default"](this._filmCardsModel.getFilmsAll());
  }
  ...
  _renderLoadMoreButton() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._loadMoreButtonComponent);
    ...
    const filmWrapper = container.querySelector(`.films-list`);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(filmWrapper, this._loadMoreButtonComponent);
    ...
    this._api.updateFilm(oldData.id, newData)
      .then((filmCardModel) => {
        ...
        if (isSuccess) {
          ...
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._siteProfileComponent);
          this._siteProfileComponent = new _components_site_profile__WEBPACK_IMPORTED_MODULE_7__["default"](this._filmCardsModel.getFilmsAll());
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(siteHeader, this._siteProfileComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
        }
      });
  ...
  resetSortType() {
    if (this._sortingComponent.getSortType(_components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].DEFAULT)) {
      this._onSortTypeChange(_components_sorting__WEBPACK_IMPORTED_MODULE_2__["SortType"].DEFAULT);
    }
  }
}
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_comment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/comment */ "./src/components/comment.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const */ "./src/const.js");
...
class CommentController {
  ...
  render(comment) {
    this._commentComponent = new _components_comment__WEBPACK_IMPORTED_MODULE_1__["default"](comment);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(containerElement, this._commentComponent);
  }

  shake() {
    this._commentComponent.getElement().style.animation = `shake ${_const__WEBPACK_IMPORTED_MODULE_2__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
...
/* harmony import */ var _controllers_comment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/comment */ "./src/controllers/comment.js");
/* harmony import */ var _models_comment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/comment */ "./src/models/comment.js");
/* harmony import */ var _models_film_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/film-card */ "./src/models/film-card.js");
...
const parseFormData = (formData) => {
  return new _models_comment__WEBPACK_IMPORTED_MODULE_3__["default"]({
    "id": null,
    "author": null,
...
class CommentsController {
  ...
  render() {
    this._commentsComponent = new _components_comments__WEBPACK_IMPORTED_MODULE_1__["default"](this._container.film);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container.getCommentsElement(), this._commentsComponent);
    this._renderComments();
  }

  shake() {
    this._commentsComponent.getNewCommentElement().style.animation = `shake ${_const__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
  ...
  _renderComments() {
    ...
    this._commentsModel.getComments(film).forEach((comment) => {
      new _controllers_comment__WEBPACK_IMPORTED_MODULE_2__["default"](this._commentsComponent, this._onCommentDataChange).render(comment);
    });
  }

  _onCommentDataChange(controller, oldData, newData) {
    const film = this._container.film;
    const newFilmCard = _models_film_card__WEBPACK_IMPORTED_MODULE_4__["default"].clone(film);
    if (newData === null) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmCardController; });
...
/* harmony import */ var _models_film_card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/film-card */ "./src/models/film-card.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _comments__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./comments */ "./src/controllers/comments.js");
...
class FilmCardController {
  ...
  render(film) {
    ...
    this._filmCardComponent = new _components_film_card__WEBPACK_IMPORTED_MODULE_0__["default"](film);
    ...
    this._filmCardComponent.setWatchlistButtonClickHandler(() => {
      const newFilmCard = _models_film_card__WEBPACK_IMPORTED_MODULE_2__["default"].clone(film);
    ...
    if (oldFilmDetailsComponent && oldFilmCardComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filmCardComponent, oldFilmCardComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filmDetailsComponent, oldFilmDetailsComponent);
      if (this._mode === Mode.EDIT) {
        this._renderComments();
      }
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._filmCardComponent);
    }
  }
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._filmCardComponent);
  }
  ...
  _renderComments() {
    new _comments__WEBPACK_IMPORTED_MODULE_4__["default"](this._filmDetailsComponent, this._api, this._commentsModel, this._onDataChange.bind(this, this)).render();
  }
}
...
class FilterController {
  ...
  render() {
    ...
    const filters = Object.values(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter__WEBPACK_IMPORTED_MODULE_3__["getFilmsByFilter"])(allTasks, filterType).length,
    ...
    if (oldComponent) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(container.getElement(), this._filterComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREBEGIN);
    }
  }
...
/* harmony import */ var _models_film_cards__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/film-cards */ "./src/models/film-cards.js");
...
/* harmony import */ var _components_statistic__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/statistic */ "./src/components/statistic.js");
...
const filmCardsModel = new _models_film_cards__WEBPACK_IMPORTED_MODULE_5__["default"]();

const commentsModel = new _models_comments__WEBPACK_IMPORTED_MODULE_3__["default"]();
const models = {filmCardsModel, commentsModel};

const navigationComponent = new _components_navigation__WEBPACK_IMPORTED_MODULE_8__["default"]();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_11__["render"])(siteMain, navigationComponent);

const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"](navigationComponent, filmCardsModel);
filterController.render();

const loadingComponent = new _components_loading__WEBPACK_IMPORTED_MODULE_7__["default"]();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_11__["render"])(siteMain, loadingComponent);


const boardComponent = new _components_board__WEBPACK_IMPORTED_MODULE_1__["default"]();
const boardController = new _controllers_board__WEBPACK_IMPORTED_MODULE_2__["default"](boardComponent, models, api);
...
api.getFilms()
  .then((films) => {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_11__["render"])(siteFooter, new _components_footer__WEBPACK_IMPORTED_MODULE_6__["default"](films));
  ...
  .finally(() => {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_11__["remove"])(loadingComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_11__["render"])(siteMain, boardComponent);
    boardController.render();
    const statisticComponent = new _components_statistic__WEBPACK_IMPORTED_MODULE_9__["default"](filmCardsModel);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_11__["render"])(siteMain, statisticComponent);
    statisticComponent.hide();

    navigationComponent.setClickHandler((item) => {
      if (item === _const_js__WEBPACK_IMPORTED_MODULE_10__["NavigationItem"].FILTER) {
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatTime, formatDate, formatPopupDate, formatCommentDate, isSelectedType, getDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatPopupDate", function() { return formatPopupDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatCommentDate", function() { return formatCommentDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSelectedType", function() { return isSelectedType; });
...
const formatTime = (date) => {
  const duration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(date, `minutes`);
...
const formatCommentDate = (date) => {
  const difference = moment__WEBPACK_IMPORTED_MODULE_0___default()().diff(date, `days`);
  const differenceMinute = moment__WEBPACK_IMPORTED_MODULE_0___default()().diff(date, `minutes`);
  if (differenceMinute < 1440) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).fromNow();
  }
  if (difference >= 1 && difference <= 31) {
    const newDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(date).fromNow();
    const time = moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`hh:mm`);
...
const isSelectedType = (dateA, dateB, type) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dateA).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(dateB), type) === 0;
};

const getDuration = (time) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(time, `minutes`);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getWatchlistFilms, getHistoryFilms, getFavoriteFilms, getFilmsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
